...
public class WikiEdit {
	...
	public static void runJob(String input, String output) throws IOException {
		...
		job.setJarByClass(WikiEdit.class);
		logger.debug("cme@ runJob setJarByClass");
				
		job.setMapperClass  (WikiEditMapper.class);
		...
		job.setReducerClass (WikiEditReducer.class);
...
//		job.setMapOutputValueClass(LongWritable.class); /* not necessary because reducer outputValueClass matches */
		...
		try {
			...
			logger.fatal("InterruptedException "+ WikiEdit.class.getName()+" "+ex);
		} catch (ClassNotFoundException ex) {
			logger.fatal("ClassNotFoundException "+ WikiEdit.class.getName()+" "+ex);
		}
	...
	public static void main(String[] args) {
		...
		try {
			...
			logger.fatal("IOException "+ WikiEdit.class.getName()+" "+ex);
		}
	}
}
