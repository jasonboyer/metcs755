...
public class WikiEditLink {
	...
	public static void runJob(String input, String output) throws IOException {
		...
		job.setJarByClass(WikiEditLink.class);
		logger.debug("cme@ runJob setJarByClass");
				
		job.setMapperClass  (WikiEditLinkMapper .class);
		...
		job.setReducerClass (WikiEditLinkReducer.class);
...
//		job.setMapOutputValueClass(LongWritable.class); /* not necessary because reducer outputValueClass matches */
		...
		try {
			...
			logger.fatal("InterruptedException "+ WikiEditLink.class.getName()+" "+ex);
		} catch (ClassNotFoundException ex) {
			logger.fatal("ClassNotFoundException "+ WikiEditLink.class.getName()+" "+ex);
		}
	...
	public static void main(String[] args) {
		...
		try {
			...
			logger.fatal("IOException "+ WikiEditLink.class.getName()+" "+ex);
		}
	}
}
