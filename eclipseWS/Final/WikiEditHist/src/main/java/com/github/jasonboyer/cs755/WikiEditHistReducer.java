...
import com.github.jasonboyer.cs755.WikiEditHistMapper.mapCounters;
...
public class WikiEditHistReducer
extends Reducer<LongWritable,NullWritable,LongWritable, LongWritable> {
	...
	@Override
	public void reduce(LongWritable key1, Iterable<NullWritable> value1s,Context context)
